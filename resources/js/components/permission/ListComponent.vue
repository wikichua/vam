...
export default {
  data() {
    return {
      dt: {
        fields: [
          { key: "group", label: "Group", sortable: true, filterable: true },
      ...
      vueRouteShow: "permission.show",
      apiRouteList: "permission.index",
      vueRouteCreate: "permission.create",
      vueRouteEdit: "permission.edit",
      apiRouteDestroy: "permission.destroy"
    };
  },
  methods: {
    loadItems(ctx) {
